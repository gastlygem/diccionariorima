...
public class UpdateGUI extends JDialog implements ActionListener, Runnable {
	...
	public UpdateGUI(JFrame frame, String basePath, Update dic, Update gen,
			Update res, Update help) {
		...
		JLabel label = new JLabel(
				"<html>&nbsp;&nbsp;&nbsp;&nbsp;Hay actualizaciones para el <b>diccionario de rimas</b>:</html>");
	...
	public void run() {
		...
		for (Iterator iterator = updates.iterator(); iterator.hasNext();) {
			...
			try {
				File temp = File.createTempFile("fm_" + update.getType(),
						".jar");
				temp.deleteOnExit();
		...
		String restart = "";
		if (dic != null)
			restart += "\nAlgunas de ellas sólo estarán disponibles después de reiniciar el diccionario.";
		JOptionPane.showMessageDialog(frame,
				"Se han terminado de realizar las actualizaciones." + restart,
