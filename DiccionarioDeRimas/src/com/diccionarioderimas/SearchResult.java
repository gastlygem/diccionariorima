...
public class SearchResult {
	...
	public SearchResult(String word, String originalWord, String normalized,String type, int silables) {
		this.word = word;
	...
	public String getComparableWord(int loc){
		...
		return new StringBuffer(normalized).append(padding[30-word.length()]).append('|').append(loc).toString();
	}
